...
impl CPU {
    ...
    pub fn execute_cb(&mut self, opcode: u8) -> u8 {
        match opcode {
            ...
            0x40 => { self.bit(0, self.b); 8 },
            0x41 => { self.bit(0, self.c); 8 },
            0x42 => { self.bit(0, self.d); 8 },
            0x43 => { self.bit(0, self.e); 8 },
            0x44 => { self.bit(0, self.h); 8 },
            0x45 => { self.bit(0, self.l); 8 },
            0x46 => {
                let temp = self.mmu.borrow().read_byte(self.get_hl());
                self.bit(0, temp);
                12
            },
            0x47 => { self.bit(0, self.a); 8 },
            0x48 => { self.bit(1, self.b); 8 },
            0x49 => { self.bit(1, self.c); 8 },
            0x4A => { self.bit(1, self.d); 8 },
            0x4B => { self.bit(1, self.e); 8 },
            0x4C => { self.bit(1, self.h); 8 },
            0x4D => { self.bit(1, self.l); 8 },
            0x4E => {
                let temp = self.mmu.borrow().read_byte(self.get_hl());
                self.bit(1, temp);
                12
            },
            0x4F => { self.bit(1, self.a); 8 },
            0x50 => { self.bit(2, self.b); 8 },
            0x51 => { self.bit(2, self.c); 8 },
            0x52 => { self.bit(2, self.d); 8 },
            0x53 => { self.bit(2, self.e); 8 },
            0x54 => { self.bit(2, self.h); 8 },
            0x55 => { self.bit(2, self.l); 8 },
            0x56 => {
                let temp = self.mmu.borrow().read_byte(self.get_hl());
                self.bit(2, temp);
                12
            },
            0x57 => { self.bit(2, self.a); 8 },
            0x58 => { self.bit(3, self.b); 8 },
            0x59 => { self.bit(3, self.c); 8 },
            0x5A => { self.bit(3, self.d); 8 },
            0x5B => { self.bit(3, self.e); 8 },
            0x5C => { self.bit(3, self.h); 8 },
            0x5D => { self.bit(3, self.l); 8 },
            0x5E => {
                let temp = self.mmu.borrow().read_byte(self.get_hl());
                self.bit(3, temp);
                12
            },
            0x5F => { self.bit(3, self.a); 8 },
            0x60 => { self.bit(4, self.b); 8 },
            0x61 => { self.bit(4, self.c); 8 },
            0x62 => { self.bit(4, self.d); 8 },
            0x63 => { self.bit(4, self.e); 8 },
            0x64 => { self.bit(4, self.h); 8 },
            0x65 => { self.bit(4, self.l); 8 },
            0x66 => {
                let temp = self.mmu.borrow().read_byte(self.get_hl());
                self.bit(4, temp);
                12
            },
            0x67 => { self.bit(4, self.a); 8 },
            0x68 => { self.bit(5, self.b); 8 },
            0x69 => { self.bit(5, self.c); 8 },
            0x6A => { self.bit(5, self.d); 8 },
            0x6B => { self.bit(5, self.e); 8 },
            0x6C => { self.bit(5, self.h); 8 },
            0x6D => { self.bit(5, self.l); 8 },
            0x6E => {
                let temp = self.mmu.borrow().read_byte(self.get_hl());
                self.bit(5, temp);
                12
            },
            0x6F => { self.bit(5, self.a); 8 },
            0x70 => { self.bit(6, self.b); 8 },
            0x71 => { self.bit(6, self.c); 8 },
            0x72 => { self.bit(6, self.d); 8 },
            0x73 => { self.bit(6, self.e); 8 },
            0x74 => { self.bit(6, self.h); 8 },
            0x75 => { self.bit(6, self.l); 8 },
            0x76 => {
                let temp = self.mmu.borrow().read_byte(self.get_hl());
                self.bit(6, temp);
                12
            },
            0x77 => { self.bit(6, self.a); 8 },
            0x78 => { self.bit(7, self.b); 8 },
            0x79 => { self.bit(7, self.c); 8 },
            0x7A => { self.bit(7, self.d); 8 },
            0x7B => { self.bit(7, self.e); 8 },
            0x7C => { self.bit(7, self.h); 8 },
            0x7D => { self.bit(7, self.l); 8 },
            0x7E => {
                let temp = self.mmu.borrow().read_byte(self.get_hl());
                self.bit(7, temp);
                12
            },
            0x7F => { self.bit(7, self.a); 8 },
            0x80 => { self.b = self.res(0, self.b); 8 },
            0x81 => { self.c = self.res(0, self.c); 8 },
            0x82 => { self.d = self.res(0, self.d); 8 },
            0x83 => { self.e = self.res(0, self.e); 8 },
            0x84 => { self.h = self.res(0, self.h); 8 },
            0x85 => { self.l = self.res(0, self.l); 8 },
            0x86 => {
                let temp = self.mmu.borrow().read_byte(self.get_hl());
                self.mmu.borrow_mut().write_byte(self.get_hl(), self.res(0, temp));
                16
            },
            0x87 => { self.a = self.res(0, self.a); 8 },
            0x88 => { self.b = self.res(1, self.b); 8 },
            0x89 => { self.c = self.res(1, self.c); 8 },
            0x8A => { self.d = self.res(1, self.d); 8 },
            0x8B => { self.e = self.res(1, self.e); 8 },
            0x8C => { self.h = self.res(1, self.h); 8 },
            0x8D => { self.l = self.res(1, self.l); 8 },
            0x8E => {
                let temp = self.mmu.borrow().read_byte(self.get_hl());
                self.mmu.borrow_mut().write_byte(self.get_hl(), self.res(1, temp));
                16
            },
            0x8F => { self.a = self.res(1, self.a); 8 },
            0x90 => { self.b = self.res(2, self.b); 8 },
            0x91 => { self.c = self.res(2, self.c); 8 },
            0x92 => { self.d = self.res(2, self.d); 8 },
            0x93 => { self.e = self.res(2, self.e); 8 },
            0x94 => { self.h = self.res(2, self.h); 8 },
            0x95 => { self.l = self.res(2, self.l); 8 },
            0x96 => {
                let temp = self.mmu.borrow().read_byte(self.get_hl());
                self.mmu.borrow_mut().write_byte(self.get_hl(), self.res(2, temp));
                16
            },
            0x97 => { self.a = self.res(2, self.a); 8 },
            0x98 => { self.b = self.res(3, self.b); 8 },
            0x99 => { self.c = self.res(3, self.c); 8 },
            0x9A => { self.d = self.res(3, self.d); 8 },
            0x9B => { self.e = self.res(3, self.e); 8 },
            0x9C => { self.h = self.res(3, self.h); 8 },
            0x9D => { self.l = self.res(3, self.l); 8 },
            0x9E => {
                let temp = self.mmu.borrow().read_byte(self.get_hl());
                self.mmu.borrow_mut().write_byte(self.get_hl(), self.res(3, temp));
                16
            },
            0x9F => { self.a = self.res(3, self.a); 8 },
            0xA0 => { self.b = self.res(4, self.b); 8 },
            0xA1 => { self.c = self.res(4, self.c); 8 },
            0xA2 => { self.d = self.res(4, self.d); 8 },
            0xA3 => { self.e = self.res(4, self.e); 8 },
            0xA4 => { self.h = self.res(4, self.h); 8 },
            0xA5 => { self.l = self.res(4, self.l); 8 },
            0xA6 => {
                let temp = self.mmu.borrow().read_byte(self.get_hl());
                self.mmu.borrow_mut().write_byte(self.get_hl(), self.res(4, temp));
                16
            },
            0xA7 => { self.a = self.res(4, self.a); 8 },
            0xA8 => { self.b = self.res(5, self.b); 8 },
            0xA9 => { self.c = self.res(5, self.c); 8 },
            0xAA => { self.d = self.res(5, self.d); 8 },
            0xAB => { self.e = self.res(5, self.e); 8 },
            0xAC => { self.h = self.res(5, self.h); 8 },
            0xAD => { self.l = self.res(5, self.l); 8 },
            0xAE => {
                let temp = self.mmu.borrow().read_byte(self.get_hl());
                self.mmu.borrow_mut().write_byte(self.get_hl(), self.res(5, temp));
                16
            },
            0xAF => { self.a = self.res(5, self.a); 8 },
            0xB0 => { self.b = self.res(6, self.b); 8 },
            0xB1 => { self.c = self.res(6, self.c); 8 },
            0xB2 => { self.d = self.res(6, self.d); 8 },
            0xB3 => { self.e = self.res(6, self.e); 8 },
            0xB4 => { self.h = self.res(6, self.h); 8 },
            0xB5 => { self.l = self.res(6, self.l); 8 },
            0xB6 => {
                let temp = self.mmu.borrow().read_byte(self.get_hl());
                self.mmu.borrow_mut().write_byte(self.get_hl(), self.res(6, temp));
                16
            },
            0xB7 => { self.a = self.res(6, self.a); 8 },
            0xB8 => { self.b = self.res(7, self.b); 8 },
            0xB9 => { self.c = self.res(7, self.c); 8 },
            0xBA => { self.d = self.res(7, self.d); 8 },
            0xBB => { self.e = self.res(7, self.e); 8 },
            0xBC => { self.h = self.res(7, self.h); 8 },
            0xBD => { self.l = self.res(7, self.l); 8 },
            0xBE => {
                let temp = self.mmu.borrow().read_byte(self.get_hl());
                self.mmu.borrow_mut().write_byte(self.get_hl(), self.res(7, temp));
                16
            },
            0xBF => { self.a = self.res(7, self.a); 8 },
            0xC0 => { self.b = self.set(0, self.b); 8 },
            0xC1 => { self.c = self.set(0, self.c); 8 },
            0xC2 => { self.d = self.set(0, self.d); 8 },
            0xC3 => { self.e = self.set(0, self.e); 8 },
            0xC4 => { self.h = self.set(0, self.h); 8 },
            0xC5 => { self.l = self.set(0, self.l); 8 },
            0xC6 => {
                let temp = self.mmu.borrow().read_byte(self.get_hl());
                self.mmu.borrow_mut().write_byte(self.get_hl(), self.set(0, temp));
                16
            },
            0xC7 => { self.a = self.set(0, self.a); 8 },
            0xC8 => { self.b = self.set(1, self.b); 8 },
            0xC9 => { self.c = self.set(1, self.c); 8 },
            0xCA => { self.d = self.set(1, self.d); 8 },
            0xCB => { self.e = self.set(1, self.e); 8 },
            0xCC => { self.h = self.set(1, self.h); 8 },
            0xCD => { self.l = self.set(1, self.l); 8 },
            0xCE => {
                let temp = self.mmu.borrow().read_byte(self.get_hl());
                self.mmu.borrow_mut().write_byte(self.get_hl(), self.set(1, temp));
                16
            },
            0xCF => { self.a = self.set(1, self.a); 8 },
            0xD0 => { self.b = self.set(2, self.b); 8 },
            0xD1 => { self.c = self.set(2, self.c); 8 },
            0xD2 => { self.d = self.set(2, self.d); 8 },
            0xD3 => { self.e = self.set(2, self.e); 8 },
            0xD4 => { self.h = self.set(2, self.h); 8 },
            0xD5 => { self.l = self.set(2, self.l); 8 },
            0xD6 => {
                let temp = self.mmu.borrow().read_byte(self.get_hl());
                self.mmu.borrow_mut().write_byte(self.get_hl(), self.set(2, temp));
                16
            },
            0xD7 => { self.a = self.set(2, self.a); 8 },
            0xD8 => { self.b = self.set(3, self.b); 8 },
            0xD9 => { self.c = self.set(3, self.c); 8 },
            0xDA => { self.d = self.set(3, self.d); 8 },
            0xDB => { self.e = self.set(3, self.e); 8 },
            0xDC => { self.h = self.set(3, self.h); 8 },
            0xDD => { self.l = self.set(3, self.l); 8 },
            0xDE => {
                let temp = self.mmu.borrow().read_byte(self.get_hl());
                self.mmu.borrow_mut().write_byte(self.get_hl(), self.set(3, temp));
                16
            },
            0xDF => { self.a = self.set(3, self.a); 8 },
            0xE0 => { self.b = self.set(4, self.b); 8 },
            0xE1 => { self.c = self.set(4, self.c); 8 },
            0xE2 => { self.d = self.set(4, self.d); 8 },
            0xE3 => { self.e = self.set(4, self.e); 8 },
            0xE4 => { self.h = self.set(4, self.h); 8 },
            0xE5 => { self.l = self.set(4, self.l); 8 },
            0xE6 => {
                let temp = self.mmu.borrow().read_byte(self.get_hl());
                self.mmu.borrow_mut().write_byte(self.get_hl(), self.set(4, temp));
                16
            },
            0xE7 => { self.a = self.set(4, self.a); 8 },
            0xE8 => { self.b = self.set(5, self.b); 8 },
            0xE9 => { self.c = self.set(5, self.c); 8 },
            0xEA => { self.d = self.set(5, self.d); 8 },
            0xEB => { self.e = self.set(5, self.e); 8 },
            0xEC => { self.h = self.set(5, self.h); 8 },
            0xED => { self.l = self.set(5, self.l); 8 },
            0xEE => {
                let temp = self.mmu.borrow().read_byte(self.get_hl());
                self.mmu.borrow_mut().write_byte(self.get_hl(), self.set(5, temp));
                16
            },
            0xEF => { self.a = self.set(5, self.a); 8 },
            0xF0 => { self.b = self.set(6, self.b); 8 },
            0xF1 => { self.c = self.set(6, self.c); 8 },
            0xF2 => { self.d = self.set(6, self.d); 8 },
            0xF3 => { self.e = self.set(6, self.e); 8 },
            0xF4 => { self.h = self.set(6, self.h); 8 },
            0xF5 => { self.l = self.set(6, self.l); 8 },
            0xF6 => {
                let temp = self.mmu.borrow().read_byte(self.get_hl());
                self.mmu.borrow_mut().write_byte(self.get_hl(), self.set(6, temp));
                16
            },
            0xF7 => { self.a = self.set(6, self.a); 8 },
            0xF8 => { self.b = self.set(7, self.b); 8 },
            0xF9 => { self.c = self.set(7, self.c); 8 },
            0xFA => { self.d = self.set(7, self.d); 8 },
            0xFB => { self.e = self.set(7, self.e); 8 },
            0xFC => { self.h = self.set(7, self.h); 8 },
            0xFD => { self.l = self.set(7, self.l); 8 },
            0xFE => {
                let temp = self.mmu.borrow().read_byte(self.get_hl());
                self.mmu.borrow_mut().write_byte(self.get_hl(), self.set(7, temp));
                16
            },
            0xFF => { self.a = self.set(7, self.a); 8 }
        }
    }
}